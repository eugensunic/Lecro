var vecernji = {
    //dovhvaca sve URL-ove sa stranice
            getUrlBlock: function (htmltext) {  // RADI
                var url_links = [];
                var i = 0;
                var inner_counter = 0;
            ...
            getArticleCleanText: function (htmltext) { // RADI
            ...
            removeAftergt: function (text_input) {  // RADI
                ...
                if (eneteredsecond == true || enteredfirst == true) { return text_input; }
                else { return text_input; }

            },
            getDate: function (array1, index) {  // RADI
            ...
            getTitle: function (array1, index) { // RADI
        var counter2 = 0;
        if (array1[index].indexOf('class="title_large') > -1) {
           ...
           getInfoBoxText: function(array1, index_counter, text_concat2) {  //nije testirano, to treba ukomponirati u ostatak
           ...
           notPremium: function(array1, index_counter) {  // RADI
           ...
           endPageMaximumNumberOfArticles: function(htmltext) { //RADI
               var lines = htmltext.split('\n');
               var i = 0;
               var tempnum = -1;
               var currentnum;
              
               while (lines[i].indexOf("pagination") <= -1) {i++;}
