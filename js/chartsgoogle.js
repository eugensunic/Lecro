...
function checkNullAndK(array1, index) {
  if (ustedevina) {
    if (array1[index].ustedevina == null || array1[index].ustedevina == undefined) {
      array1[index].ustedevina = '0';
    ...
    if (array1[index].nekretnine == null || array1[index].nekretnine == undefined) {
      array1[index].nekretnine = '0';
    ...
    if (array1[index].placa == null || array1[index].placa == undefined) {
      array1[index].placa = '0';
    ...
    if (array1[index].broj_nekretnina == null || array1[index].broj_nekretnina == undefined) {
      array1[index].broj_nekretnina = '0';
    ...
    if (array1[index].broj_optuznica == null || array1[index].broj_optuznica == undefined) {
      array1[index].broj_optuznica = '0';
