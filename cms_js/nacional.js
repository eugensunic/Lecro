var nacional = {
  getUrlBlock: function(htmltext) {
    //RADI, samo stavlja urlove u listbox
  ...
  getArticlesUrlPage: function(htmltext) {
    // RADI, jednostavni je ipak bez return-a
    var i = 0;
    var lines = htmltext.split('\n');
    var inner_counter = 0;
  ...
  getDate: function getDate(array1, index) {
    //RADI
  ...
  getTitle: function getTitle(array1, index) {
    // RADI
  ...
  getUrlGazeta: function(htmltext) {
    //RADI
    var i = 0;
    var lines = htmltext.split('\n');
    var url_counter = 0;
  ...
  getArticleCleanText: function(htmltext) {
    //RADI , dohvacanje cistog texta i stavljanje u  #first textarea
    var i = 0;
    var lines = htmltext.split('\n');
    var text_concat = '';
